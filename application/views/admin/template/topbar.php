       ...
       <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow">
         ...
         <ul class="navbar-nav ml-auto">
           ...
           <!--             <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
            ...
            $header_permission = '';
            $CI = &get_instance();
            $data = $CI->auth_users->profileget();
            // print_r($data[0]->staff_name);
            //  print_R($sidebar_permission);
            ?>
            <!-- Nav Item - User Information -->
           <li class="nav-item dropdown no-arrow">
             <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
               <span class="mr-2 d-none d-lg-inline text-white-500 large" style="font-size:15px;">Welcome!! <span><?php echo $data[0]->staff_name ?></span></span>
               <img style="width:30px; height:30px;" class="img-profile rounded-circle" src="<?php echo $data[0]->image ?>">
             </a>
