...
<div class="all_post">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <a href="<?php echo base_url();?>admin/services/newpost"><button class="ad">+</button></a>
            </div>
        </div>    
        <div class="row">
            <div class="col-md-12">
...
<div id="deletePurchaseModal" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <?php echo form_open(base_url('admin/servicess/categary/deletepost'), array('method'=>'post'));?>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h4><b>Do you really want to Delete this service category ?</b></h4>
                    </div>
                </div>
            </div>
...
<script>
  $(document).ready(function() {
    $('#lowinventory').DataTable( {
        "ajax": "<?php echo base_url(); ?>admin/servicess/categary/addinventory_api"
    } );
