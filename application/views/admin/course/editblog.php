...
<div class="new-post">
    <div class="container">
        ...
        ?>
        <h3>Update Course</h3>
        <form method="post" action="<?php echo base_url()?>admin/course/editblog/update" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box">
                        ...
                        <input type="text" name="name" placeholder="Enter Course Name" value="<?php echo $value['name']?>" required>

                        <label>Course Delivery</label>
                        <input type="text" name="delivery" placeholder="Enter Course Delivery " value="<?php echo $value['delivery']?>" required>

                        <label>Course lenght</label>
                        <input type="text" name="lenght" placeholder="Enter Course lenght" value="<?php echo $value['lenght']?>" required>

                        <label>Course code</label>
                        <input type="text" name="code" placeholder="Enter Course code" value="<?php echo $value['code']?>" required>
