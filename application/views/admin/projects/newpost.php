            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box">
                        ...
                        <textarea name="about" placeholder="Enter Short Description" cols="30" rows="10" required></textarea>
                        ...
                        <input type="text" name="link" placeholder="Enter client website link" required>
