            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box">
                        ...
                        <input type="text" name="web_name" placeholder="Enter  Name" value="<?php echo $value['web_name']?>" required>
                        <label> Wlcome Post</label>
                        <input type="text" name="welcome" placeholder="Enter  Name" value="<?php echo $value['welcome']?>" required>
                        ...
                        <img width="150px" src="<?php echo base_url()?>upload/extra/<?php echo $value['image']?>"><br><br>
