<?php
  class Allpost extends CI_Controller{
        ...
        public function index(){
            ...
            $this->load->view('admin/course/allpost',);
       ...
       public function addinventory_api(){
            ...
            foreach ($getPurchaseData as $key => $value) { 
                ...
                $arrya_json[] = array($value['id'],$value['name'],$value['cate'],$value['delivery'],$value['lenght'],$value['code'],'<a href="'.base_url().'admin/course/editblog?id='.$value['id'].'"    >Edit</a>',
