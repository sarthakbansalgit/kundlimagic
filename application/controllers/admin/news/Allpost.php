<?php
  class Allpost extends CI_Controller{
        ...
        public function index(){
            ...
            $this->load->view('admin/news/allpost');
       ...
       public function addinventory_api(){
            ...
            foreach ($getPurchaseData as $key => $value) { 
                ...
                $arrya_json[] = array($value['id'],$value['name'],'<img src="'.base_url().'upload/news/'.$value['cover'].'">',$value['date'],'<a href="'.base_url().'admin/news/editblog?id='.$value['id'].'"    >Edit</a>',
